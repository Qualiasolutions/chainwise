...
const categoryConfig: Record<string, { icon: JSX.Element; name: string; gradient: string; description: string }> = {
  ...
  'tools': {
    ...
    description: 'AI-powered trading and portfolio optimization tools'
  },
  'reports': {
  ...
  'trading': {
    ...
    description: 'Advanced trading strategies and regulatory insights'
  }
}
...
export function PremiumFeaturesMarketplaceEnhanced() {
  ...
  const fetchFeatures = async () => {
    try {
      // Features from source of truth
      const featuresData: FeaturesData = {
        user: {
          tier: 'elite', // Default to elite as per requirements
          credits: creditBalance || 200
        },
        features: {
          analysis: [
            {
              id: '1',
              feature_key: 'whale_tracker',
              name: 'Whale Wallet Tracker',
              description: 'Track large wallet movements and analyze market impact',
              category: 'analysis',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                ...
                benefits: ['Real-time whale movements', 'Transaction analysis', 'Market impact alerts'],
                popular: true
              }
            },
            {
              id: '2',
              feature_key: 'narrative_deep_scan',
              name: 'Narrative & Trend Deep Scans',
              description: 'AI-powered deep dive into market narratives and emerging trends',
              category: 'analysis',
              credit_cost: 10,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_scan',
                benefits: ['Market narrative analysis', 'Trend prediction', 'Sentiment insights'],
                popular: true
              }
            },
            {
              id: '3',
              feature_key: 'ai_deep_dive_report',
              name: 'Deep Dive AI Reports',
              description: 'Comprehensive AI-generated investment analysis reports',
              category: 'analysis',
              credit_cost: 10,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_report',
                benefits: ['Detailed market analysis', 'Investment recommendations', 'Risk assessment']
              }
            },
            {
              id: '4',
              feature_key: 'scam_fraud_check',
              name: 'Advanced Scam & Fraud Checks',
              description: 'Protect your investments with AI-powered fraud detection',
              category: 'analysis',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_scan',
                benefits: ['Scam detection', 'Smart contract analysis', 'Security scoring']
              }
            }
          ],
          tools: [
            {
              id: '5',
              feature_key: 'ai_stress_test',
              name: 'AI Stress Tests',
              description: 'Test your portfolio against various market scenarios',
              category: 'tools',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_run',
                benefits: ['Scenario modeling', 'Risk simulation', 'Portfolio optimization']
              }
            },
            {
              id: '6',
              feature_key: 'smart_dca_planner',
              name: 'Smart DCA & Exit Plans',
              description: 'AI-optimized dollar-cost averaging and exit strategies',
              category: 'tools',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_plan',
                benefits: ['Automated DCA plans', 'Exit strategies', 'Performance tracking']
              }
            },
            {
              id: '7',
              feature_key: 'nft_analyzer',
              name: 'NFT Analyzers',
              description: 'Comprehensive NFT collection and asset analysis',
              category: 'tools',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_scan',
                benefits: ['NFT valuation', 'Rarity analysis', 'Market trends']
              }
            },
            {
              id: '8',
              feature_key: 'defi_yield_analyzer',
              name: 'DeFi Yield Analyzer',
              description: 'Analyze and optimize DeFi yield farming opportunities',
              category: 'tools',
              credit_cost: 8,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                ...
                benefits: ['Yield optimization', 'Risk analysis', 'Pool recommendations']
              }
            }
          ],
          reports: [
            {
              id: '9',
              feature_key: 'extra_pro_report',
              name: 'Extra Pro Reports',
              description: 'Additional weekly professional portfolio reports beyond your tier limit',
              category: 'reports',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'pro',
              metadata: {
                frequency: 'per_report',
                benefits: ['Weekly insights', 'Performance metrics', 'Market analysis']
              }
            },
            {
              id: '10',
              feature_key: 'extra_elite_report',
              name: 'Extra Elite Reports',
              description: 'Additional monthly elite deep dive reports beyond your tier limit',
              category: 'reports',
              credit_cost: 10,
              pricing_usd: null,
              required_tier: 'elite',
              metadata: {
                frequency: 'per_report',
                benefits: ['Deep market analysis', 'Strategic insights', 'Trend predictions'],
                popular: true
              }
            }
          ],
          trading: [
            {
              id: '11',
              feature_key: 'trading_playbook',
              name: 'Trading Playbook Simulations',
              description: 'Advanced trading strategy simulations and backtesting',
              category: 'trading',
              credit_cost: 10,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                frequency: 'per_run',
                benefits: ['Strategy backtesting', 'Risk simulation', 'Performance optimization']
              }
            },
            {
              id: '12',
              feature_key: 'regulatory_radar',
              name: 'Regulatory Radar',
              description: 'Stay ahead of regulatory changes affecting your portfolio',
              category: 'trading',
              credit_cost: 5,
              pricing_usd: null,
              required_tier: 'free',
              metadata: {
                ...
                benefits: ['Regulatory updates', 'Compliance monitoring', 'Risk alerts']
              }
            }
          ]
        },
