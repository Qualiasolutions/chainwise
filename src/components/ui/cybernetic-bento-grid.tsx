...
// Enhanced BentoItem component with intense yet smooth animations
  ...
  return (
    <motion.div
      ...
      transition={{
        ...
        rotateX: { duration: 1.1, ease: [0.25, 0.46, 0.45, 0.94] },
        rotateY: { duration: 1.1, ease: [0.25, 0.46, 0.45, 0.94] },
        z: { duration: 1.0, ease: "easeOut" }
      }}
      whileHover={{
        y: -15,
        scale: 1.05,
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-gradient-to-b from-slate-950/80 via-slate-900/60 to-slate-950/80"
      />
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 1.5, delay: 0.5, ease: [0.175, 0.885, 0.32, 1.275] }}
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/4 w-32 h-32 bg-cyan-500/10 rounded-full blur-2xl animate-pulse delay-500"
        />
      </motion.div>

      {/* Grid pattern overlay with animated entrance */}
      <motion.div
