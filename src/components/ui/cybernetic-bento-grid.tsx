  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-8">
      <div className="w-full max-w-6xl z-10">
        <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 text-center mb-8">
          Core Features
        </h1>
        <div className="bento-grid">
          <BentoItem className="col-span-2 row-span-2 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-800">Real-time Market Analytics</h2>
              </div>
            ...
            <div className="mt-4 h-48 bg-neutral-800/50 rounded-lg flex items-center justify-center border border-neutral-700">
              <div className="text-center">
                ...
                <span className="text-slate-600">Live Market Data</span>
              </div>
            </div>
          </BentoItem>
          ...
          <BentoItem>
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-bold text-slate-800">Secure Portfolio</h2>
            </div>
            <p className="text-slate-600 text-sm">
          ...
          <BentoItem className="row-span-2">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-bold text-slate-800">Portfolio Management</h2>
            </div>
            ...
            <div className="mt-auto">
              <div className="bg-neutral-800/50 rounded-lg p-4 border border-neutral-700">
                ...
                <div className="text-slate-800 font-bold text-lg">$45,678.90</div>
              </div>
            </div>
          </BentoItem>
          ...
          <BentoItem className="col-span-2">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-bold text-slate-800">Lightning-Fast Execution</h2>
            </div>
            <p className="text-slate-600 text-sm">
