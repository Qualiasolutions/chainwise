...
export async function POST(
  ...
  try {
    ...
    if (existingHolding) {
      ...
      const existingCost = existingAmount * parseFloat(existingHolding.average_purchase_price_usd)
      ...
      const { data: updatedHolding, error: updateError } = await supabase
        ...
        .update({
          ...
          current_value_usd: (totalAmount * parseFloat(existingHolding.current_price_usd || existingHolding.average_purchase_price_usd)).toString(),
